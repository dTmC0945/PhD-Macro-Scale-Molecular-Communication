...
x           = 0.1;                      % Transmission Distance (cm)
...
for  D_L = 0.1:0.1:0.4
    ...
    for Es_N0 = l_min:l_mid:l_max                                       % Counter operator (dB)
        ...
        [inputMatrix, probabilityMatrix, Rn] = decodingSimulation2D(levelCounter, bitLength, symbolDuration, noisedSignal, normal, randomBits1, randomBits2);
